...
{
  if (tab === Tab.Overview) {return <MovieOverview film={film}/>;}
  if (tab === Tab.Details) {return <MovieDetails film={film}/>;}
  if (tab === Tab.Reviews) {return <MovieReviews reviews={reviews}/>;}
}
